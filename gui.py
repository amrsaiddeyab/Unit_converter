...
class Unit_converter_weight():
    def __init__(self, weight_converter):
        ...
        self.weight_unit_t_convert_var= tk.StringVar(self.root_weight, value="Unit")
        self.weight_unit_after_var= tk.StringVar(self.root_weight, value="Unit")

        self.weight_number_to_convert= tk.Entry(self.root_weight,
        ...
        self.weight_unit_to_convert= tk.Entry(self.root_weight,
                        textvariable= self.weight_unit_t_convert_var,
        ...
        self.weight_unit_after= tk.Entry(self.root_weight,
                        textvariable= self.weight_unit_after_var,
                        width=7, font=("Arial", 15, "bold"), bd=4)
        self.weight_unit_after.grid(row=8,column=0, sticky='w')
    ...
    def weight_convert_display(self, input_number, input_unit_t_convert, input_unit_after, result):
        self.weight_convert_window= tk.Tk()
        ...
        self.weight_result= tk.Label(self.weight_convert_window, text=f"{input_number}{input_unit_t_convert} = {result}{input_unit_after}",
                        bg="blue", fg="white",
                        font=("Arial", 30, "bold"))
        self.weight_result.grid(row=3, column=0, columnspan=2, sticky="we")

    def weight_error(self, e1='0', e2='0'):
        self.weight_error_window= tk.Tk()
        ...
        if (e1 != '0' and e2 != '0'):
            ...
            self.weight_result= tk.Label(self.weight_error_window,
                        text=f"1. 'Numbers' must be a number greater than or equal to zero",
                            bg="blue", fg="white",
                            font=("Arial", 15, "bold"))
...
class Unit_converter_distance():
    def __init__(self, distance_converter):
        ...
        self.distance_unit_t_convert_var= tk.StringVar(self.root_distance, value="Unit")
        self.distance_unit_after_var= tk.StringVar(self.root_distance, value="Unit")

        self.distance_number_to_convert= tk.Entry(self.root_distance,
        ...
        self.distance_unit_to_convert= tk.Entry(self.root_distance,
                        textvariable= self.distance_unit_t_convert_var,
                        width=7,
                        font=("Arial", 15, "bold"), bd=4,
                        fg='#6AA121')
        ...
        self.distance_unit_after= tk.Entry(self.root_distance,
                            textvariable= self.distance_unit_after_var,
                            width=7,
                            font=("Arial", 15, "bold"), bd=4,
                            fg='#6AA121')
        self.distance_unit_after.grid(row=8,column=0, sticky='w')
    ...
    def distance_convert_display(self, input_number, input_unit_t_convert, input_unit_after, result):
        self.distance_convert_window= tk.Tk()
        ...
        self.distance_result= tk.Label(self.distance_convert_window, text=f"{input_number}{input_unit_t_convert} = {result}{input_unit_after}",
                        bg="#4CC417", fg="white",
                        font=("Arial", 30, "bold"))
        self.distance_result.grid(row=3, column=0, columnspan=2, sticky="we")

    def distance_error(self, e1='0', e2='0'):
        self.distance_error_window= tk.Tk()
...
class Unit_converter_time():
    def __init__(self, time_converter):
        ...
        self.time_unit_t_convert_var= tk.StringVar(self.root_time, value="Unit")
        self.time_unit_after_var= tk.StringVar(self.root_time, value="Unit")

        self.time_number_to_convert= tk.Entry(self.root_time,
        ...
        self.time_unit_to_convert= tk.Entry(self.root_time,
                        textvariable= self.time_unit_t_convert_var,
                        width=7,
                        font=("Arial", 15, "bold"), bd=4,
                        fg="#504A4B")
        ...
        self.time_unit_after= tk.Entry(self.root_time,
                        textvariable= self.time_unit_after_var,
                        width=7,
                        font=("Arial", 15, "bold"), bd=4,
                        fg="#504A4B")
        self.time_unit_after.grid(row=8,column=0, sticky='w')
    ...
    def time_convert_display(self, input_number, input_unit_t_convert, input_unit_after, result):
        self.time_convert_window= tk.Tk()
        ...
        self.time_result= tk.Label(self.time_convert_window, text=f"{input_number}{input_unit_t_convert} = {result}{input_unit_after}",
                        bg="#A9A9A9", fg="white",
                        font=("Arial", 30, "bold"))
        self.time_result.grid(row=3, column=0, columnspan=2, sticky="we")

    def time_error(self, e1='0', e2='0'):
        self.time_error_window= tk.Tk()
